            ...
            <div class="modal-body">
                <form id="edit-task-form">
                    ...
                    <div class="form-group">
                        <label for="edit-cat-exp">Phone</label>
                        <input type="text" name="phone" id="edit-cat-phone" placeholder="" class="form-control">
                        <input type="hidden" name="employee_id" id="edit-cat-id">
                    </div>
                </form>
            </div>
...
<script>
    ...
    const editStaffUrl = '/api/edit_staff';
    function submitEditForm(){
        ...
        Swal.fire({
            title: 'Are you sure you want to update this phone number?',
